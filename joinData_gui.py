...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.loadEOS.setGeometry(QtCore.QRect(440, 40, 101, 28))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.loadEOS.setFont(font)
        self.loadEOS.setObjectName("loadEOS")
        self.loadEXIF = QtWidgets.QPushButton(Form)
        self.loadEXIF.setGeometry(QtCore.QRect(440, 100, 101, 28))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label.setGeometry(QtCore.QRect(260, 150, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.headerOffset = QtWidgets.QLineEdit(Form)
        self.headerOffset.setGeometry(QtCore.QRect(390, 149, 41, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
